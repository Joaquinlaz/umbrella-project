...
import os
import hashlib
# Agregado solo para cumplir con el requisito de monitorización
...
def login():
    if request.method == 'POST':
        ...
        # Inyección de SQL (Código Original Vulnerable)
        if "' OR '" in password:
...
def remove_server_header(response):
    ...
    response.headers.pop('X-Powered-By', None)  # opcional
    return response
...
# --- RUTA NUEVA PARA MONITORIZACIÓN (Requisito Evaluación) ---
@app.route('/metrics')
def metrics():
